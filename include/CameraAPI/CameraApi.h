...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
MVSDK_API CameraSdkStatus __stdcall CameraGetSysOption(
	char const* optionName,
	char * value
	);
...
/// \brief ??????????LUT????
/// \param [in] hCamera ?????????
/// \param [in] iChannel ?????څ??LUT???????????@link #LUT_CHANNEL_ALL @endlink????????????LUT???????�I??@see emSdkLutChannel
...
/// @ingroup API_EXPOSURE
/// \~chinese
/// \brief ?څ??????????????????څ??��[@link #tSdkExpose.uiTargetMin @endlink, @link #tSdkExpose.uiTargetMax @endlink]
/// \param [in] hCamera ?????????
/// \param [in] iAeTarget ??????????
/// \return ??????? CAMERA_STATUS_SUCCESS(0)????????0????????, ??��? CameraStatus.h ?��????????�^
/// \~english
...
/// \return ??????? CAMERA_STATUS_SUCCESS(0)????????0????????, ??��? CameraStatus.h ?��????????�^
/// \note ????CMOS???????????????��????????????????????????��???????????????????????????????????????????????څ???????????????@link #CameraGetExposureTime @endlink?????????څ?????
/// \~english
...
/// \param [in] fExposureTime ????????��???
/// \return ??????? CAMERA_STATUS_SUCCESS(0)????????0????????, ??��? CameraStatus.h ?��????????�^
/// \note ????CMOS???????????????��????????????????????????��???????????????????????????????????????????????څ???????????????@link #CameraGetMultiExposureTime @endlink?????????څ?????
/// \~english
...
/// \param [in] hCamera ?????????
/// \param [in] index ?????????
/// \param [in] iGamma ??څ??Gamma???
/// \return ??????? CAMERA_STATUS_SUCCESS(0)????????0????????, ??��? CameraStatus.h ?��????????�^
/// \note ?څ??????????????SDK???????????��???????????????????LUT??????????��????��?@link #CameraSetLutMode @endlink?????????????
/// \~english
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
MVSDK_API CameraSdkStatus __stdcall CameraSetMultiExposureExpDelay(
	CameraHandle    hCamera, 
	int				index,
	double          fExpDelay
	);
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
/// \see CameraSetMultiExposureExpDelay
MVSDK_API CameraSdkStatus __stdcall CameraGetMultiExposureExpDelay(
	CameraHandle    hCamera, 
	int				index,
	double*         pfExpDelay
	);
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
MVSDK_API CameraSdkStatus __stdcall CameraSetMultiExposureStrobeWidth(
	CameraHandle    hCamera, 
	int				index,
	double          fStrobeWidth
	);
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
/// \see CameraSetMultiExposureStrobeWidth
MVSDK_API CameraSdkStatus __stdcall CameraGetMultiExposureStrobeWidth(
	CameraHandle    hCamera, 
	int				index,
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
MVSDK_API CameraSdkStatus __stdcall CameraSetMultiExposureStrobeOutSel(
	CameraHandle    hCamera, 
	int				index,
	UINT			uStrobeOutSel
	);
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
/// \see CameraSetMultiExposureStrobeOutSel
MVSDK_API CameraSdkStatus __stdcall CameraGetMultiExposureStrobeOutSel(
	CameraHandle    hCamera, 
	int				index,
	UINT*			puStrobeOutSel
	);
...
/// \brief ???????????????????��??(????????????????)
/// \param [in] hCamera ?????????
/// \param [out] pSupported ?????????????bit0=1???2?????????bit1=1???3?? ????????
/// \return ??????? CAMERA_STATUS_SUCCESS(0)????????0????????, ??��? CameraStatus.h ?��????????�^
/// \~english
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
MVSDK_API CameraSdkStatus __stdcall CameraGetMultiExposureBlendingSupported(
	CameraHandle    hCamera, 
	UINT*			pSupported
	);
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
MVSDK_API CameraSdkStatus __stdcall CameraSetMultiExposureBlendingEnable(
	CameraHandle    hCamera, 
	BOOL			bEnable
	);
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
MVSDK_API CameraSdkStatus __stdcall CameraGetMultiExposureBlendingEnable(
	CameraHandle    hCamera, 
	BOOL*			pbEnable
	);
...
/// \brief ????????????????
/// \param [in] hCamera ?????????
/// \param [in] pRatios ?????????????��0-100?????%0-%100??
/// \param [in] iNumRatios ????????????????=???????-1??????3?????????????2??????????3=100-(???1+???2)??
/// \return ??????? CAMERA_STATUS_SUCCESS(0)????????0????????, ??��? CameraStatus.h ?��????????�^
/// \~english
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
MVSDK_API CameraSdkStatus __stdcall CameraSetMultiExposureBlendingRatios(
	CameraHandle    hCamera, 
	int*			pRatios,
	int				iNumRatios
	);
...
/// \param [in] hCamera ?????????
/// \param [out] pRatios ??????
/// \param [inout] piNumRatios ???????????????????????pRatios?????��   ??????????????????????(???????-1)
/// \return ??????? CAMERA_STATUS_SUCCESS(0)????????0????????, ??��? CameraStatus.h ?��????????�^
/// \~english
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
MVSDK_API CameraSdkStatus __stdcall CameraGetMultiExposureBlendingRatios(
	CameraHandle    hCamera, 
	int*			pRatios,
	int*			piNumRatios
	);
...
/// \param [in] iBGain   ???????????????
/// \return ??????? CAMERA_STATUS_SUCCESS(0)????????0????????, ??��? CameraStatus.h ?��????????�^
/// \note ?څ??��??@link #tRgbGainRange @endlink????????????????????څ?/100??
/// \~english
...
/// \brief ?څ????????????
/// \param [in] hCamera ?????????
/// \param [in] iSaturation  ?څ????????? 
/// \return ??????? CAMERA_STATUS_SUCCESS(0)????????0????????, ??��? CameraStatus.h ?��????????�^
/// \note ?????????��???څ??��??@link #tSaturationRange @endlink??��?100????????????????
/// \~english
...
/// \param [in] pImageResolution ?????
/// \return ??????? CAMERA_STATUS_SUCCESS(0)????????0????????, ??��? CameraStatus.h ?��????????�^
/// \note ???pImageResolution->iWidth = pImageResolution->iHeight = 0???????څ????��?????????????????????????????څ???????????????
/// \~english
...
/// \param [in] pLightFieldingImage ??????
/// \param [in] pLightFieldingFrInfo ?????????
/// \param [in] pRefRegion ?��???????????????????????????NULL????��?????????????
/// \param [in] pActRegion ??????????????????????NULL????????
/// \return ??????? CAMERA_STATUS_SUCCESS(0)????????0????????, ??��? CameraStatus.h ?��????????�^
/// \~english
/// \brief Set flat field correction parameters
/// \param [in] hCamera Camera handle.
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
MVSDK_API CameraSdkStatus __stdcall CameraFlatFieldingCorrectSetParameterEx(
	CameraHandle hCamera,
	BYTE const* pDarkFieldingImage,
	tSdkFrameHead const* pDarkFieldingFrInfo,
	BYTE const* pLightFieldingImage,
...
/// \param [in] bEnable  ????????
/// \param [in] nCount   ??��????????��???(2-8??)
/// \param [in] Weights  ?????????�y???3???????��???????????????????3??????(0.3,0.3,0.4)???????????????????2????????????????????????????????0???????????????????(0.33,0.33,0.33)
/// \return ??????? CAMERA_STATUS_SUCCESS(0)????????0????????, ??��? CameraStatus.h ?��????????�^
/// \~english
...
/// \brief ???????????????????????????��??????????????
/// \param [in] hCamera ?????????
/// \param [inout] pUserBuffer ???????????????????
/// \param [inout] pUserBufferSize ????????��???????��??????????????????????????????????��????????��?????pUserBuffer=NULL??????????????��????????��??
/// \return ??????? CAMERA_STATUS_SUCCESS(0)????????0????????, ??��? CameraStatus.h ?��????????�^
/// \note ????????????????@link CameraWaitUserBufferSnap @endlink?????????
/// \~english
...
MVSDK_API CameraSdkStatus __stdcall CameraSubmitUserBufferSnap(
	CameraHandle	hCamera,
	BYTE*			pUserBuffer,
...
MVSDK_API CameraSdkStatus __stdcall CameraCancelUserBufferSnap(
	CameraHandle	hCamera,
	BYTE*			pUserBuffer
	);
...
/// \param [in] hCamera ?????????
/// \param [in] pUserBuffer ??????????????????????
/// \param [out] pSnapStatus ???????????CAMERA_STATUS_SUCCESS????????????????????????
/// \param [out] pFrameInfo ????????????
/// \param [out] ppImgStart ?????????????
/// \param [in] wTimes ?????????????��??????wTimes??????��????????��?????????????
/// \return ??????? CAMERA_STATUS_SUCCESS(0)????????0????????, ??��? CameraStatus.h ?��????????�^
/// \note ?????????????????????��???????????????????��??????????????????????????????????ppImgStart?????????????????????
/// \~english
...
MVSDK_API CameraSdkStatus __stdcall CameraWaitUserBufferSnap(
	CameraHandle	hCamera,
	BYTE*			pUserBuffer,
	INT*			pSnapStatus,
	tSdkFrameHead*	pFrameInfo,
